...
def run_maven_command():
    print(f"\n{EMOJI['rocket']} Starting Application Compilation Process")
    ...
    try:
        ...
        # Changed the project directory from 'acme-db' to 'acme-api'
        project_dir = os.path.join(os.path.dirname(__file__), '..', '..', 'acme-api')
        ...
        print(f"\n{EMOJI['success']} Packageing of the acme-api Completed Successfully")
